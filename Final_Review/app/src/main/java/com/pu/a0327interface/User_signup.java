...
public class User_signup extends AppCompatActivity {
    ...
    Button btn_signup;
    String account,password,name,phone,email;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText ed_account,ed_password,ed_phone,ed_name,ed_email;
        ...
        btn_signup=findViewById(R.id.btn_search);
        btn_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(getApplicationContext(),account+" "+password+name+phone+email,Toast.LENGTH_LONG).show();
                //finish();
                //Intent intent = new Intent(User_signup.this,User_login.class);
                //startActivity(intent);
                if(account.matches("") || password.matches("") || name.matches("") || phone.matches("") || email.matches("")){
                    Toast.makeText(getApplicationContext(),"欄位不能為空",Toast.LENGTH_LONG).show();
                }else {
                    DownloadAsyncTask dTask = new DownloadAsyncTask();
                    dTask.execute(urlpath+"user_signup.php", "...", "...");
                }
            }
        });
    }
    ...
    class DownloadAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                ...
                String parms="user_account="+account+"&user_password="+password+"&user_name="+name+"&user_phone="+phone+"&user_email="+email;
            ...
            try {
               ...
               // Log.d("json",signup);
                if(signup.equals("true")){
                    ...
                    Toast.makeText(getApplicationContext(),"請輸入別的帳號",Toast.LENGTH_LONG).show();
                    Log.d("json","already");
                }
